                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        v-model="editedItem.cane_cuted_type_name"
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "ชื่อ", value: "cane_cuted_type_name" },
      { text: "Actions", value: "actions", sortable: false },
    ],
    desserts: [],
    editedIndex: -1,
    editedItem: {
      cane_cuted_type_name: "",
      user_created: 0,
      user_updated: 0,
    },
    editedItem2: {
  ...
  methods: {
    async initialize() {
      ...
      //   alert("initialize");
      const res_get = await api.getCaneCutedType();
    ...
    async deleteItemConfirm() {
      ...
      const res_del = await api.deleteCaneCutedType(this.edit_item_id);
    ...
    async save() {
      if (this.editedIndex > -1) {
        ...
        this.editedItem2.cane_cuted_type_name = this.editedItem.cane_cuted_type_name;
        const res_edit = await api.updateCaneCutedType(
          this.edit_item_id,
          this.editedItem2
        );
        ...
        const res_add = await api.addCaneCutedType(this.editedItem);
