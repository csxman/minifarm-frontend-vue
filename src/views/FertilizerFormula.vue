                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        v-model="editedItem.fertilizer_formula_name"
                        label="ชื่อสูตรปุ๋ย"
                        outlined
                      ></v-text-field>
                    </v-col>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "ชื่อ", value: "fertilizer_formula_name" },
      { text: "Actions", value: "actions", sortable: false },
    ],
    desserts: [],
    editedIndex: -1,
    editedItem: {
      fertilizer_formula_name: "",
      user_created: 0,
      user_updated: 0,
    },
    editedItem2: {
  ...
  methods: {
    async initialize() {
      ...
      //   alert("initialize");
      const res_get = await api.getFertilizerFormula();
    ...
    async deleteItemConfirm() {
      ...
      const res_del = await api.deleteFertilizerFormula(this.edit_item_id);
    ...
    async save() {
      if (this.editedIndex > -1) {
        ...
        this.editedItem2.fertilizer_formula_name = this.editedItem.fertilizer_formula_name;
        const res_edit = await api.updateFertilizerFormula(
          this.edit_item_id,
          this.editedItem2
        );
        ...
        const res_add = await api.addFertilizerFormula(this.editedItem);
