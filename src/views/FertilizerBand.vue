                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        v-model="editedItem.fertilizer_band_name"
                        label="ชื่อยี่ห้อปุ๋ย"
                        outlined
                      ></v-text-field>
                    </v-col>
                  </v-row>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "ชื่อ", value: "fertilizer_band_name" },
      { text: "Actions", value: "actions", sortable: false },
    ],
    desserts: [],
    editedIndex: -1,
    editedItem: {
      fertilizer_band_name: "",
      user_created: 0,
      user_updated: 0,
    },
    editedItem2: {
  ...
  methods: {
    async initialize() {
      ...
      //   alert("initialize");
      const res_get = await api.getFertilizerBand();
    ...
    async deleteItemConfirm() {
      ...
      const res_del = await api.deleteFertilizerBand(this.edit_item_id);
    ...
    async save() {
      if (this.editedIndex > -1) {
        ...
        this.editedItem2.fertilizer_band_name = this.editedItem.fertilizer_band_name;
        const res_edit = await api.updateFertilizerBand(
          this.edit_item_id,
          this.editedItem2
        );
        ...
        const res_add = await api.addFertilizerBand(this.editedItem);
