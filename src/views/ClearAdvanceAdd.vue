  ...
  <v-card-title>
    <v-container class="pa-10">
      ...
      <v-card class="pa-10">
        ...
        <v-row align="center" justify="center">
          <v-col cols="12" md="6">
            <v-radio-group v-model="radioGroup" @change="changeradio()">
              <v-radio key="cash" label="Cash" value="cash"></v-radio>

              <v-radio key="cheque" label="Cheque" value="cheque"></v-radio>
              <v-col v-show="pickcheque">
                <v-text-field
                  outlined
                  dense
                  label="Cheque No. :"
              ...
              <v-radio key="bank" label="Bank" value="bank"></v-radio>
              <v-col v-show="pickbank">
                <v-autocomplete
            ...
            <v-col>
              <v-text-field outlined dense label="note :"></v-text-field>
            </v-col>
          </v-col>
        ...
        <v-row>
          <v-col align="center" cols="12" md="2"> </v-col>
...
export default {
  ...
  data() {
    return {
      ...
      totalleftoveramount: 150,
      sumwithdrawamount: 1000,
      sunamountcleared: 850,
      showallamount: "",
      mDataArray: [
        {
          no: "Fee001",
      ...
      headers: [
        ...
        { text: "Details", value: "detail", class: "bg-colorth" },
        {
          text: "Withdraw Amount",
          value: "withdrawamount",
          class: "bg-colorth",
        },
        { text: "Clear Amount", value: "amountcleared", class: "bg-colorth" },
      ],
    };
  },
  components: {
