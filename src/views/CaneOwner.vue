                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        v-model="editedItem.cane_owner_name"
                        label="ชื่อสถานะการครอบครองแปลง"
                        outlined
                      ></v-text-field>
                    </v-col>
                  </v-row>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "ชื่อ", value: "cane_owner_name" },
  ...
  methods: {
    async initialize() {
      ...
      //   alert("initialize");
      const res_get = await api.getCaneOwner();
    ...
    async deleteItemConfirm() {
      ...
      const res_del = await api.deleteCaneOwner(this.edit_item_id);
    ...
    async save() {
      if (this.editedIndex > -1) {
        ...
        this.editedItem2.cane_owner_name = this.editedItem.cane_owner_name;
        const res_edit = await api.updateCaneOwner(
          this.edit_item_id,
          this.editedItem2
        );
        ...
        const res_add = await api.addCaneOwner(this.editedItem);
