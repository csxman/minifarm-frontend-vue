                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        v-model="editedItem.ldlt_name"
                        label="ชื่อเอกสารสิทธิ์"
                        outlined
                      ></v-text-field>
                    </v-col>
                  </v-row>
...
export default {
  ...
  methods: {
    async initialize() {
      ...
      //   alert("initialize");
      const res_get = await api.getLandDLT();
    ...
    async deleteItemConfirm() {
      ...
      const res_del = await api.deleteLandDLT(this.edit_item_id);
    ...
    async save() {
      if (this.editedIndex > -1) {
        ...
        this.editedItem2.ldlt_name = this.editedItem.ldlt_name;
        const res_edit = await api.updateLandDLT(
          this.edit_item_id,
          this.editedItem2
        );
        ...
        const res_add = await api.addLandDLT(this.editedItem);
