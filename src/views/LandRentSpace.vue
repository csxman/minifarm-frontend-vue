                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        v-model="editedItem.land_rent_space_name"
                        label="ชื่อสถานะแปลง"
                        outlined
                      ></v-text-field>
                    </v-col>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "ชื่อ", value: "land_rent_space_name" },
  ...
  methods: {
    async initialize() {
      ...
      //   alert("initialize");
      const res_get = await api.getLandRentSpace();
    ...
    async deleteItemConfirm() {
      ...
      const res_del = await api.deleteLandRentSpace(this.edit_item_id);
    ...
    async save() {
      if (this.editedIndex > -1) {
        ...
        this.editedItem2.land_rent_space_name = this.editedItem.land_rent_space_name;
        const res_edit = await api.updateLandRentSpace(
          this.edit_item_id,
          this.editedItem2
        );
        ...
        const res_add = await api.addLandRentSpace(this.editedItem);
