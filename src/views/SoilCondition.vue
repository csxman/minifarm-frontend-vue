                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        v-model="editedItem.soil_condition_name"
                        label="ชื่อประเภทดิน"
                        outlined
                      ></v-text-field>
                    </v-col>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "ชื่อ", value: "soil_condition_name" },
  ...
  methods: {
    async initialize() {
      ...
      //   alert("initialize");
      const res_get = await api.getSoilCondition();
    ...
    async deleteItemConfirm() {
      ...
      const res_del = await api.deleteSoilCondition(this.edit_item_id);
    ...
    async save() {
      if (this.editedIndex > -1) {
        ...
        this.editedItem2.soil_condition_name = this.editedItem.soil_condition_name;
        const res_edit = await api.updateSoilCondition(
          this.edit_item_id,
          this.editedItem2
        );
        ...
        const res_add = await api.addSoilCondition(this.editedItem);
