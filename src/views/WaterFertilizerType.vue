                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        v-model="editedItem.water_fertilizer_type_name"
                        label="ชื่อประเภทปุ๋ยน้ำ"
                        outlined
                      ></v-text-field>
                    </v-col>
                  </v-row>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "ชื่อ", value: "water_fertilizer_type_name" },
  ...
  methods: {
    async initialize() {
      ...
      //   alert("initialize");
      const res_get = await api.getWaterFertilizerType();
    ...
    async deleteItemConfirm() {
      ...
      const res_del = await api.deleteWaterFertilizerType(this.edit_item_id);
    ...
    async save() {
      if (this.editedIndex > -1) {
        ...
        this.editedItem2.water_fertilizer_type_name = this.editedItem.water_fertilizer_type_name;
        const res_edit = await api.updateWaterFertilizerType(
          this.edit_item_id,
          this.editedItem2
        );
        ...
        const res_add = await api.addWaterFertilizerType(this.editedItem);
