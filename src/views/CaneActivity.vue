                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        v-model="editedItem.cane_activity_name"
                        label="ชื่อประเภทกิจกรรม - อ้อย"
                        outlined
                      ></v-text-field>
                    </v-col>
                  </v-row>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "ชื่อ", value: "cane_activity_name" },
  ...
  methods: {
    async initialize() {
      ...
      //   alert("initialize");
      const res_get = await api.getCaneActivity();
    ...
    async deleteItemConfirm() {
      ...
      const res_del = await api.deleteCaneActivity(this.edit_item_id);
    ...
    async save() {
      if (this.editedIndex > -1) {
        ...
        this.editedItem2.cane_activity_name = this.editedItem.cane_activity_name;
        const res_edit = await api.updateCaneActivity(
          this.edit_item_id,
          this.editedItem2
        );
        ...
        const res_add = await api.addCaneActivity(this.editedItem);
