                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        v-model="editedItem.cane_cropyear_name"
                        label="ชื่อปีการผลิต"
                        outlined
                      ></v-text-field>
                    </v-col>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "ชื่อ", value: "cane_cropyear_name" },
  ...
  methods: {
    async initialize() {
      ...
      //   alert("initialize");
      const res_get = await api.getCaneCropyear();
    ...
    async deleteItemConfirm() {
      ...
      const res_del = await api.deleteCaneCropyear(this.edit_item_id);
    ...
    async save() {
      if (this.editedIndex > -1) {
        ...
        this.editedItem2.cane_cropyear_name = this.editedItem.cane_cropyear_name;
        const res_edit = await api.updateCaneCropyear(
          this.edit_item_id,
          this.editedItem2
        );
        ...
        const res_add = await api.addCaneCropyear(this.editedItem);
