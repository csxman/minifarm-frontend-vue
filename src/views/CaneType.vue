                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        v-model="editedItem.cane_type_name"
                        label="ชื่อประเภทอ้อย"
                        outlined
                      ></v-text-field>
                    </v-col>
                  </v-row>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "ชื่อ", value: "cane_type_name" },
  ...
  methods: {
    async initialize() {
      ...
      //   alert("initialize");
      const res_get = await api.getCaneType();
    ...
    async deleteItemConfirm() {
      ...
      const res_del = await api.deleteCaneType(this.edit_item_id);
    ...
    async save() {
      if (this.editedIndex > -1) {
        ...
        this.editedItem2.cane_type_name = this.editedItem.cane_type_name;
        const res_edit = await api.updateCaneType(
          this.edit_item_id,
          this.editedItem2
        );
        ...
        const res_add = await api.addCaneType(this.editedItem);
