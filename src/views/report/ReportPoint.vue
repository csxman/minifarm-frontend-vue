...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      {
        text: "point_cost_per_rai",
        align: "center",
        value: "point_cost_per_rai",
      },
      {
        text: "point_cost_avg",
        align: "center",
        value: "point_cost_avg",
      },
      {
        text: "desc",
        align: "center",
  ...
  methods: {
    ...
    onClickEditStatus(item) {
      // alert(item.id);
      // this.$router.push("/report-point-detail/" + item.id);
    ...
    async getReportData() {
      ...
      const res_get = await api.getActivityPoint();
      ...
      //     tmp.point_no = element.point_no;
      //     tmp.point_area = element.point_area;
