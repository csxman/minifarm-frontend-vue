      ...
      <v-col cols="12">
        <v-btn outlined color="indigo">
          <vue-excel-xlsx
            :data="data"
            :columns="columns"
            :file-name="'cane-plant'"
            :file-type="'xlsx'"
            :sheet-name="'cane-plant'"
          >
            Download Excel
          </vue-excel-xlsx>
        </v-btn>
...
export default {
  ...
  methods: {
    ...
    async getReportData() {
      ...
      const res_get = await api.getActivityPlant();
      ...
      res_get.data.forEach((element) => {
        var tmp = {
          ...
          quota_name: "0 null",
          act_name: "ปลูกอ้อย",
          plant_type_name: "คนปลูก",
          varieties_name: "ขอนแก่น3",
          bundle_sum: 10,
          driver_user_name: "พขร ที่1",
          pay_name: "สินเชื่อ",
          cost_rai: 1245,
          cost_avg: 24825.3,
          image: "image-1654920559344.png",
          desc: null,
          user_created: "นาย วิทยา จันทร์ฟอง",
          created_at: "2022-06-11T04:09:21.000Z",
        };
        ...
        tmp.plant_type_name = element.plant_type_name;
        tmp.varieties_name = element.varieties_name;
        tmp.bundle_sum = element.bundle_sum;
