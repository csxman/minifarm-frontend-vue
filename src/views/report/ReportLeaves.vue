      ...
      <v-col cols="12">
        <v-btn outlined color="indigo">
          <vue-excel-xlsx
            :data="data"
            :columns="columns"
            :file-name="'cane-leaves'"
            :file-type="'xlsx'"
            :sheet-name="'cane-leaves'"
          >
            Download Excel
          </vue-excel-xlsx>
        </v-btn>
...
export default {
  ...
  methods: {
    ...
    async getReportData() {
      ...
      const res_get = await api.getActivityLeaves();
      ...
      res_get.data.forEach((element) => {
        var tmp = {
          ...
          quota_name: "0 null",
          act_name: "อัดใบ",
          driver_user_name: "พขร ที่2",
          leave_user_name: "CH-09",
          pay_name: "เงินสด",
          cost_rai: 1235,
          cost_avg: 24625.9,
          image: "image-1654920994170.png",
          desc: "ถถถ",
          user_created: "นาย วิทยา จันทร์ฟอง",
          created_at: "2022-06-11T04:16:35.000Z",
        };
        ...
        tmp.leave_user_name = element.leave_user_name;
