      ...
      <v-col cols="12">
        <v-btn outlined color="indigo">
          <vue-excel-xlsx
            :data="data"
            :columns="columns"
            :file-name="'report-canecut'"
            :file-type="'xlsx'"
            :sheet-name="'report-canecut'"
          >
            Download Excel
          </vue-excel-xlsx>
        </v-btn>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      },
      {
        text: "ประเภทตัด",
        align: "center",
        value: "cuted_type_name",
      },
      {
        text: "ชื่อรถ",
        align: "center",
        value: "harvest_carcut_name",
      },
      {
        text: "ทะเบียนรถบรรทุก",
        align: "center",
        value: "harvest_truck_license_plate",
      },
      {
        text: "รูป",
        align: "center",
    ...
    columns: [
      ...
      {
        label: "ประเภทตัด",
        field: "cuted_type_name",
      },
      {
        label: "ชื่อรถ",
        field: "harvest_carcut_name",
      },
      {
        label: "ทะเบียนรถบรรทุก",
        field: "harvest_truck_license_plate",
      },
      {
        label: "ต้นทุน/ไร่",
        field: "cost_rai",
  ...
  methods: {
    ...
    async getReportData() {
      ...
      const res_get = await api.getActivityCanecut();
      // this.data = res_get.data;

      res_get.data.forEach((element) => {
        var tmp = {
          id: 7,
          plot_key: "201128120718634",
          plot_no: "6034120004",
          plot_area: 29.58,
          quota_id: 1017,
          quota_name: "นายไฉน ศรีเชียงษา",
          act_name: "ตัดอ้อย",
          type_cut_name: "อ้อยสด",
          cuted_type_name: "รถตัด",
          harvest_carcut_name: "CH-10",
          harvest_truck_license_plate: null,
          pay_name: "สินเชื่อ",
          cost_rai: 100,
          cost_avg: 2958,
          image: "image-1670297290529.png",
          desc: "",
          user_created: "702146",
          created_at: "2022-12-06T03:28:14.000Z",
        };
        ...
        tmp.type_cut_name = element.type_cut_name;
        tmp.cuted_type_name = element.cuted_type_name;
        tmp.harvest_carcut_name = element.harvest_carcut_name;
        tmp.harvest_truck_license_plate = element.harvest_truck_license_plate;
        tmp.pay_name = element.pay_name;
