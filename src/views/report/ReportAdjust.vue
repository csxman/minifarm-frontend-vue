      ...
      <v-col cols="12">
        <v-btn outlined color="indigo">
          <vue-excel-xlsx
            :data="data"
            :columns="columns"
            :file-name="'report-adjust'"
            :file-type="'xlsx'"
            :sheet-name="'report-adjust'"
          >
            Download Excel
          </vue-excel-xlsx>
        </v-btn>
...
export default {
  ...
  methods: {
    ...
    async getReportData() {
      ...
      const res_get = await api.getActivityAdjust();
      ...
      res_get.data.forEach((element) => {
        var tmp = {
          ...
          act_name: "ถมสระ",
          pay_name: "เงินสด",
          driver_name: "พขร ที่1",
          driver_register: "3456",
          cost_rai: 1232,
          cost_avg: 24566.1,
          image: "image-1654920322441.png",
          desc: "คคคค",
          user_created: "นาย วิทยา จันทร์ฟอง",
          created_at: "2022-06-11T04:05:25.000Z",
        };
        ...
        tmp.driver_register = element.driver_register;
