                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        v-model="editedItem.varieties_name"
                        label="ชื่อพันธุ์อ้อย"
                        outlined
                      ></v-text-field>
                    </v-col>
                  </v-row>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "ชื่อ", value: "varieties_name" },
  ...
  methods: {
    async initialize() {
      ...
      //   alert("initialize");
      const res_get = await api.getCaneVarieties();
    ...
    async deleteItemConfirm() {
      ...
      const res_del = await api.deleteCaneVarieties(this.edit_item_id);
    ...
    async save() {
      if (this.editedIndex > -1) {
        ...
        this.editedItem2.varieties_name = this.editedItem.varieties_name;
        const res_edit = await api.updateCaneVarieties(
          this.edit_item_id,
          this.editedItem2
        );
        ...
        const res_add = await api.addCaneVarieties(this.editedItem);
