                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        v-model="editedItem.land_activity_name"
                        label="ชื่อประเภทกิจกรรม - ที่ดิน"
                        outlined
                      ></v-text-field>
                    </v-col>
                  </v-row>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "ชื่อ", value: "land_activity_name" },
  ...
  methods: {
    async initialize() {
      ...
      //   alert("initialize");
      const res_get = await api.getLandActivity();
    ...
    async deleteItemConfirm() {
      ...
      const res_del = await api.deleteLandActivity(this.edit_item_id);
    ...
    async save() {
      if (this.editedIndex > -1) {
        ...
        this.editedItem2.land_activity_name = this.editedItem.land_activity_name;
        const res_edit = await api.updateLandActivity(
          this.edit_item_id,
          this.editedItem2
        );
        ...
        const res_add = await api.addLandActivity(this.editedItem);
